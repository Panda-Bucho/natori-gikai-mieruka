...
- **議員一覧** (`index.html`): 議員名(議会公式プロフィールへリンク)・会派・年齢・期数・常任委員会・発信媒体リンクのアイコン表示。行クリックで全所属委員会・生年月日等の詳細を展開
...
- **一般質問** (`questions.html`): 議員×定例会の登壇マトリクス(直近5年、市議選マーカー付き)と質問テーマ一覧。議長・副議長・監査委員の在任中セルには役職名、初当選前のセルには「—」を表示。出典は名取市議会映像配信サイトで、各セルから質問映像へリンク
