...
- **投票率** (`turnout.html`): 名取市議会議員選挙(2024年1月執行、投票率35.55%)を宮城県内市町村の直近の議員一般選挙と比較する散布図(横軸対数・べき乗近似線)、投票日当日の気象(降水量・気温)との関係を見る軸切替散布図、全35市町村の出典表。現時点では宮城県内のみが対象(全国一括の公的統計が存在しないため選管公表資料・選挙ドットコムから収集)
...
- 宮城県内各市町村選挙管理委員会の公表資料・[選挙ドットコム](https://go2senkyo.com/)(投票率データ)
